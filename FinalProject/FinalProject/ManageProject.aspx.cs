...
namespace FinalProject
{
    public partial class ManageProject : System.Web.UI.Page
    {
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into proTable values ('" + txtProjectID.Text + "','" + txtProjectTitle.Text + "','" + txtProjectType.Text + "','" + txtProjectDescription.Text + "','" + txtProjectApplication.Text + "')";
            cmd.ExecuteNonQuery();
            txtProjectID.Text = "";
